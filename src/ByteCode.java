...
/*
 * Saurabh Pansare - 50286756 - sppansar
 * 
 * Meha Raote -  50290771 - meharaje
 */
class FunTab {
...
public class ByteCode {
	...
	public static void gen_goto(int n) {
		...
		code[codeptr] = instr;
		str_code[str_codeptr] = instr + value;
		arg[codeptr] = n;
		str_codeptr++;
		codeptr++;
	...
	public static void gen_invoke(int n) {
		...
		String instr = "invokevirtual ";

		code[codeptr] = instr;
		str_code[str_codeptr] = instr + " #" + n;
		arg[codeptr] = n;
		str_codeptr++;
		codeptr++;
		// missing code: to be filled in by you.
	...
	public static void gen_aload() {

		String instr = "aload_0";
		code[codeptr] = instr;
		str_code[str_codeptr] = instr;
		str_codeptr++;
		codeptr++;
